        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <a
              ...
              className="mt-3 inline-flex items-center gap-1.5 text-xs text-foreground/40 hover:text-foreground transition-colors"
            >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-foreground/60">
              <li><span className="text-foreground/30 cursor-default">Lifestyle</span></li>
              <li><span className="text-foreground/30 cursor-default">Opinion</span></li>
