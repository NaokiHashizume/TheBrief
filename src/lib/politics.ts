...
export const legislators: Legislator[] = [
  ...
  { name: "上野 賢一郎", nameEn: "Ueno Kenichiro", party: "自由民主党", role: "厚生労働大臣", chamber: "house" },
  { name: "鈴木 憲和", nameEn: "Suzuki Norikazu", party: "自由民主党", role: "農林水産大臣", chamber: "house" },
  { name: "金子 恭之", nameEn: "Kaneko Yasushi", party: "自由民主党", role: "国土交通大臣", chamber: "house", x: "https://x.com/nekotanchan" },
  { name: "石原 宏高", nameEn: "Ishihara Hirotaka", party: "自由民主党", role: "環境大臣", chamber: "house" },
  { name: "平口 洋", nameEn: "Hiraguchi Hiroshi", party: "自由民主党", role: "法務大臣", chamber: "house" },
  { name: "松本 尚", nameEn: "Matsumoto Takashi", party: "自由民主党", role: "デジタル大臣", chamber: "house" },
  { name: "赤間 二郎", nameEn: "Akama Jiro", party: "自由民主党", role: "国家公安委員長", chamber: "house" },
  { name: "黄川田 仁志", nameEn: "Kikawada Hitoshi", party: "自由民主党", role: "こども政策担当大臣", chamber: "house" },
  { name: "城内 実", nameEn: "Kiuchi Minoru", party: "自由民主党", role: "経済財政政策担当大臣", chamber: "house", x: "https://x.com/MinoruKiuchi" },
  { name: "萩生田 光一", nameEn: "Hagiuda Koichi", party: "自由民主党", role: "衆議院議員", chamber: "house", x: "https://x.com/haaborecord" },
  { name: "世耕 弘成", nameEn: "Seko Hiroshige", party: "自由民主党", role: "衆議院議員", chamber: "house", x: "https://x.com/SekoHiroshige" },
  { name: "河野 太郎", nameEn: "Kono Taro", party: "自由民主党", role: "衆議院議員", chamber: "house", x: "https://x.com/konotarogomame", website: "https://www.taro.org/" },
  { name: "西村 康稔", nameEn: "Nishimura Yasutoshi", party: "自由民主党", role: "衆議院議員", chamber: "house", x: "https://x.com/nishy03", website: "https://www.nishimura-yasutoshi.jp/" },
  { name: "加藤 勝信", nameEn: "Kato Katsunobu", party: "自由民主党", role: "衆議院議員", chamber: "house", x: "https://x.com/KatsunobuKato1" },
  { name: "新藤 義孝", nameEn: "Shindo Yoshitaka", party: "自由民主党", role: "衆議院議員", chamber: "house", x: "https://x.com/shaborecord" },
  // ━━━━━━━━━━ 自由民主党 — 参議院 ━━━━━━━━━━
  ...
  { name: "牧野 たかお", nameEn: "Makino Takao", party: "自由民主党", role: "復興大臣", chamber: "council" },
  ...
  { name: "有村 治子", nameEn: "Arimura Haruko", party: "自由民主党", role: "参議院議員", chamber: "council" },
  { name: "三原 じゅん子", nameEn: "Mihara Junko", party: "自由民主党", role: "参議院議員", chamber: "council", x: "https://x.com/miaborecord" },
