...
export const economyNews: EconomyNewsItem[] = [
  ...
  {
    date: "2026-04-04",
    title: "日経平均、53,123円　中東情勢の原油高で反落",
  ...
  {
    date: "2026-04-01",
    title: "2026年度予算が成立、一般会計122.3兆円で過去最大",
    summary: "一般会計総額122.3兆円（前年度比+7兆円）の予算が成立。国債費31.3兆円、社会保障費39.1兆円。税収は83.7兆円と過去最高を見込む。",
    category: "fiscal",
    impact: "neutral",
  },
  {
    date: "2026-03-21",
    title: "2月コアCPI、前年比+1.6%　約4年ぶり2%割れ",
  ...
  },
  {
    ...
    summary: "連合の第1回集計（1,100組合）で賃上げ率は5.26%。自動車・電機など大手で満額回答が相次ぎ、33年ぶりの高水準を維持。",
    category: "labor",
    impact: "positive",
  },
  {
