...
export const policyIndicators: PolicyGoal[] = [
  {
    ...
    current: "69%（2026年4月24〜26日・日経・テレビ東京調査、前月比▲3pt）",
    progress: 77,
    status: "on-track",
    statusLabel: "高水準を維持",
    lastUpdated: "2026-04",
  ...
  },
  {
    ...
    current: "+5.09%（2026年春闘3次集計・3年連続5%台）",
    progress: 90,
    status: "on-track",
    statusLabel: "目標達成ペース",
    lastUpdated: "2026-04",
  },
  {
    ...
    current: "+1.8%（2026年3月・前年同月比、コアCPI）",
    progress: 76,
    status: "on-track",
    statusLabel: "目標水準に近づく",
    lastUpdated: "2026-04",
  },
  {
    id: "food-tax",
  ...
  },
  {
    ...
    target: "2026年7月発足",
    current: "衆院内閣委で可決（4月22日）・衆院本会議で可決（4月23日）、参院審議中",
    progress: 70,
    status: "on-track",
    statusLabel: "衆院通過・参院審議中",
    lastUpdated: "2026-04",
  },
  {
    id: "disaster",
