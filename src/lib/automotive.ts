...
export const automakers: Automaker[] = [
  {
    ...
    latestNews: [
      ...
      { date: "2026-04-03", headline: "米関税の影響で純利益35%減・通期影響1.4兆円と下方修正" },
  ...
  },
  {
    ...
    latestNews: [
      ...
      { date: "2026-04-01", headline: "新CFOにジョージ・レオンディス就任、Re:Nissan再建計画を加速" },
  ...
  },
  {
    ...
    latestNews: [
      ...
      { date: "2026-03-09", headline: "初の軽商用BEV「eエブリイ」を国内発売・一充電航続距離257km" },
  ...
  },
  {
    ...
    latestNews: [
      ...
      { date: "2026-04-02", headline: "EZ-6/Mazda6eが2026ワールドカーデザイン・オブ・ザ・イヤーを受賞" },
    ],
  },
  {
    slug: "subaru",
    ...
    latestNews: [
      ...
      { date: "2026-03-01", headline: "通期純利益63%減・米関税影響が2,100億円に拡大と再修正" },
  ...
  },
  {
    ...
    latestNews: [
      ...
      { date: "2026-04-01", headline: "2026年Q1北米販売2.7万台・SUVラインナップが前年比10%超増" },
    ],
  },
  {
    slug: "daihatsu",
