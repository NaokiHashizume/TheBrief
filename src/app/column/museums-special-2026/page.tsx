...
const SUMMARY =
  "建築・コレクション・地域性。2026年に体験したい、日本を代表する美術館10館を厳選。各館の見どころと、2026年に開催される企画展ラインナップを一覧で紹介します。";
    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      >
        ...
        <p className="mt-5 max-w-2xl text-sm md:text-[15px] leading-relaxed text-foreground/70">
          建築・コレクション・地域性。2026年に体験したい日本の美術館を、東京・京橋から直島・青森まで10館に絞って紹介します。各館の見どころに加え、2026年に開催される企画展のラインナップを一覧でまとめました。
        </p>
