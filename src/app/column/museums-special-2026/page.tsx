...
const TITLE = "美術館特集 2026 — 一度は訪れたい日本の美術館13選";
const SUMMARY =
  "建築・コレクション・地域性。2026年に体験したい、日本を代表する美術館13館を厳選。各館の見どころと、2026年に開催される企画展ラインナップを一覧で紹介します。";
...
const museums: Museum[] = [
  ...
  },
  {
    ...
    why: "産業デザインと現代美術の境界線を、日本独自の文脈で見ることができる稀有な施設。日常の道具・素材・身体感覚を問い直す視点で展覧会が組まれる。",
    exhibitions2026: [
      {
        title: "スープはいのち",
        period: "2026年3月27日 — 8月9日",
        description:
          "デザイナー・遠山昇司が展覧会ディレクターを務め、『スープ』を切り口に衣食住を見つめ直す企画。『包む』『味わう』『満たす』など12の動詞で展示空間を構成し、写真・インスタレーション・香り・布・音まで動員してスープから見える生活のサイクルを描く。",
      },
    ],
  },
  {
    ...
    why: "公共美術館が街の経済と観光をどう変えたかの、最も成功した日本のケーススタディ。2026年は2027年5月からの長期休館と『金沢まちなか芸術祭（仮）』を見据えた区切りの年。",
    note: "2027年5月〜2028年3月は空調・電気などの設備更新と修繕工事のため長期休館予定。2026年は『見納め』のタイミングとして訪れたい。",
    exhibitions2026: [
      {
        title: "路上、お邪魔ですか？",
        period: "2026年予定",
        description:
          "『歩く』『移動する』という行為を切り口に、美術館コレクションを再編成する企画展。一歩踏み出すという行為を起点に、外の世界の観察と内省という二つの『歩み』を作品から拾い直す。",
      },
      {
        title: "今日から明日へ（仮）",
        period: "2026年予定",
        description:
          "長期休館を控えた美術館の現在地を見つめ直し、作品を未来へ継承することの意味を問う企画。修復や継承方法の検討を要するメディアアートやインスタレーションを中心に、保存の課題そのものを来館者に開示する野心作。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    why: "戦前の地方産業資本が、いかに早期から西洋美術を体系的に集めていたかを知る原点。2026年は改修工事を経て、リニューアル後初の大型特別展が控える。",
    note: "2026年2月9日 — 4月24日は改修工事のため長期休館。再開後の最初の大型企画展に注目。",
    exhibitions2026: [
      {
        title: "倉敷大原家と中国絵画",
        period: "2026年4月25日 — 6月7日",
        description:
          "倉敷の発展を支えた大原家が代々収集した中国絵画にフォーカスする特別展。六代孝四郎、七代孫三郎、八代總一郎の三代を軸に、元時代から近代に至る名品の数々を紹介。西洋美術館としての顔とは別の、東洋美術の系譜が見える企画。",
      },
    ],
  },
  {
    ...
    why: "ベネッセによるアート×離島再生の成功例は、地域経済と文化の関係を語るうえで欠かせない事例。2025年に直島新美術館が開館し、島全体のアート体験が大きく更新された。",
    note: "完全予約制。地中美術館自体は基本的に恒久展示のみだが、ベネッセアートサイト直島の関連施設・プログラムが2026年も継続して動く。",
    exhibitions2026: [
      {
        title: "恒久展示（モネ・タレル・デ・マリア）",
        period: "通年",
        description:
          "クロード・モネの『睡蓮』連作、ジェームズ・タレルの光の体験作品、ウォルター・デ・マリアの巨大な空間作品の3室を、自然光のみで一日かけて鑑賞する。建築自体が作品の一部となる独特の空間体験は通年公開。",
      },
      {
        title: "直島新美術館 開館記念展示（西沢立衛設計・2025年5月開館）",
        period: "2026年も継続",
        description:
          "ベネッセアートサイト直島と関係の深い作家12名／組による代表作と新作を展示。地中美術館・李禹煥美術館・ベネッセハウスミュージアム・家プロジェクトと組み合わせて、島全体を一つの『大きな美術館』として体験できる。",
      },
      {
        title: "パブリック・プログラム『ヘリ・ドノ』",
        period: "2026年4月26日",
        description:
          "インドネシアを代表するアーティスト、ヘリ・ドノを迎える特別パフォーマンス＆トークプログラム。直島のアートが、東南アジアの作家とどう接続しているかを体感できる一日。",
      },
    ],
  },
  {
    ...
    why: "自動車産業の城下町が、文化への投資をどう続けてきたかという地方公共美術館の成熟例。2026年度は再評価が進む日本人画家と海外巨匠の展覧会が並ぶ充実の年度。",
    exhibitions2026: [
      {
        title: "没後50年 髙島野十郎展 / VISION 星と星図 III",
        period: "2026年1月6日 — 3月15日",
        description:
          "孤高のリアリズム画家・髙島野十郎の没後50年を期した大規模回顧展。星空を主題にした『VISION 星と星図』シリーズ第3弾も同時開催で、二つの異なる『見ること』が交差する。",
      },
      {
        title: "櫃田伸也 — 通り過ぎた風景",
        period: "2026年4月4日 — 6月21日",
        description:
          "愛知を拠点に画家・教育者として活動してきた櫃田伸也の個展。半世紀以上にわたる絵画と素描を辿り、戦後日本の絵画教育と地域芸術の交点を浮かび上がらせる。",
      },
      {
        title: "アンドリュー・ワイエス展",
        period: "2026年7月18日 — 9月23日",
        description:
          "20世紀アメリカを代表するリアリズム画家、アンドリュー・ワイエスの本格的な日本展。テンペラと水彩で描かれた静謐な風景と人物像が、谷口吉生の白い建築空間と共鳴する。",
      },
      {
        title: "井田照一 没後20年記念展 / 長谷川繁展",
        period: "2026年秋",
        description:
          "現代版画の井田照一の没後20年を期した回顧展と、画家・長谷川繁の個展を同時期に開催。日本の戦後版画と現代絵画、二つの系譜を並走させる構成。",
      },
    ],
  },
  {
    ...
    why: "地域固有のモチーフを建築・コレクションに織り込んだ、地方美術館のアイデンティティ設計の好例。2026年度は開館20周年の節目で、三本の特別企画が並ぶ。",
    exhibitions2026: [
      {
        title: "誕生70周年記念 ミッフィー展",
        period: "2026年4月18日 — 6月21日",
        description:
          "オランダの絵本作家ディック・ブルーナが生んだミッフィー（うさこちゃん）の誕生70周年を記念する展覧会。原画やデザイン資料を通じて、戦後ヨーロッパのグラフィックデザインがどう児童文化を変えたかを辿る。",
      },
      {
        title: "「装飾する魂」展（仮称）",
        period: "2026年7月 — 9月（予定）",
        description:
          "開館20周年を記念する企画。芸術人類学者・鶴岡真弓を監修に迎え、ケルト美術から縄文文化、日本のフォークアートまで、『ユーロ=アジア世界』に生き続ける『装飾する魂』の系譜を辿る。青森の文化財も多数登場予定。",
      },
      {
        title: "東日本大震災15年「志賀理江子」展（仮称）",
        period: "2026年10月 — 2027年3月（予定）",
        description:
          "東日本大震災から15年の節目に、宮城を拠点に活動を続ける写真家・志賀理江子の個展を開催。震災と東北の風土を主題化してきた作家が、いま何を見ているのかを問う、東北の美術館ならではの企画。",
      },
    ],
  },
];
    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      >
        ...
        <p className="mt-5 max-w-2xl text-sm md:text-[15px] leading-relaxed text-foreground/70">
          建築・コレクション・地域性。2026年に体験したい日本の美術館を、上野・京橋から直島・青森まで13館に絞って紹介します。各館の見どころに加え、2026年に開催される企画展のラインナップを一覧でまとめました。
        </p>
      ...
      <section className="mt-10">
        <div className="mb-4 flex items-baseline justify-between">
          <h2 className="font-serif text-2xl font-bold">セレクト13館</h2>
