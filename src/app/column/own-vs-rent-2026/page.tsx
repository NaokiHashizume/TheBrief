    ...
    <div className="max-w-[760px] mx-auto px-5 sm:px-6 py-16">
      ...
      <header className="mb-14">
        ...
        <h1 className="font-serif text-[28px] sm:text-[40px] font-bold leading-[1.2] tracking-tight">
          <span style={{ color: COLUMN_COLOR }}>持ち家 vs 賃貸</span>
          <br className="hidden sm:block" />
          <span className="text-foreground/70 text-[20px] sm:text-[28px]">— 2026年の金利と物価で再計算する</span>
        </h1>
      ...
      >
        ...
        <p className="text-[12.5px] text-foreground/60 leading-[1.9]">
          本コラムは2026年4月時点の市場環境に基づく一般的な情報提供を目的としています。試算は特定の前提に依存しており、実際の住宅購入・賃貸の判断は個別の状況・地域・物件・家族構成により異なります。具体的な意思決定にあたっては、ファイナンシャルプランナー・不動産専門家にご相談ください。
        </p>
      </div>
