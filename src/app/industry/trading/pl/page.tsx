...
export default function Page() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <BreadcrumbJsonLd items={[{ name: "Home", href: "/" }, { name: "Industry", href: "/industry" }, { name: "商社・卸売", href: "/industry/trading" }, { name: "PL", href: "/industry/trading/pl" }]} />
      ...
      <div className="mb-8">
        <h1 className="font-serif text-2xl md:text-3xl font-bold"><T ja="商社・卸売 — 損益計算書（PL）" en="Trading & Wholesale — Profit & Loss" /></h1>
