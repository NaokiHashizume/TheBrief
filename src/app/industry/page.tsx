...
const activeIndustries = new Set(["ict", "trading", "retail", "ai", "automotive", "construction", "services", "finance", "pharma", "food", "energy", "materials", "logistics", "dining", "specialty", "daily", "entertainment"]);
