...
export const alt = "The Brief — Industry 業界別ニュース";
    ...
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "linear-gradient(135deg, #064e3b 0%, #065f46 100%)", padding: 60 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ fontSize: 64, fontWeight: 900, color: "#ffffff", lineHeight: 1.15, letterSpacing: -2, fontFamily: "Georgia, serif" }}>業界別ニュース</div>
          <div style={{ fontSize: 22, color: "rgba(255,255,255,0.45)", marginTop: 16, letterSpacing: 1 }}>Industry · Business · Markets</div>
          <div style={{ display: "flex", marginTop: 24 }}>
            {["小売", "自動車", "金融", "ICT", "医薬品"].map((tag, i) => (
              <div key={i} style={{ fontSize: 12, color: "#34d399", background: "rgba(52,211,153,0.1)", border: "1px solid rgba(52,211,153,0.25)", borderRadius: 6, padding: "4px 12px", marginRight: 8 }}>{tag}</div>
            ))}
          </div>
        </div>
