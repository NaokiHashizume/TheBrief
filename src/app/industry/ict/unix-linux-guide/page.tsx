...
import {
  UnixLinuxTimelineDiagram,
  UnixLinuxComparisonDiagram,
  LinuxShareStatsDiagram,
  LinuxDistroComparisonDiagram,
  LinuxKernelArchitectureDiagram,
} from "@/components/UnixLinuxDiagrams";
import ShareButton from "@/components/ShareButton";
import { TagLink } from "@/components/TagLink";
import { T } from "@/components/T";

const SLUG = "unix-linux-guide";
...
const diagramMap: Record<string, React.FC> = {
  "unix-linux-timeline": UnixLinuxTimelineDiagram,
  "unix-linux-comparison": UnixLinuxComparisonDiagram,
  "linux-share-stats": LinuxShareStatsDiagram,
  "linux-distro-comparison": LinuxDistroComparisonDiagram,
  "linux-kernel-architecture": LinuxKernelArchitectureDiagram,
};

export default function UnixLinuxGuidePage() {
  const article = ictArticles.find((a) => a.slug === SLUG);
