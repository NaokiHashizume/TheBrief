...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "エンタメ PL（損益計算書） — Industry",
    description: "エンタメの損益計算書（PL）の業界構造を解説。売上原価率・販管費率・営業利益率の特徴と主要企業のシェア。",
    url: "https://thebrief.info/industry/entertainment/pl",
    siteName: "The Brief",
    locale: "ja_JP",
    type: "website",
  },
...
export default function Page() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <BreadcrumbJsonLd items={[{ name: "Home", href: "/" }, { name: "Industry", href: "/industry" }, { name: "エンタメ", href: "/industry/entertainment" }, { name: "PL", href: "/industry/entertainment/pl" }]} />
      ...
      <div className="mb-8">
        <h1 className="font-serif text-2xl md:text-3xl font-bold"><T ja="エンタメ — 損益計算書（PL）" en="Entertainment — Profit & Loss" /></h1>
