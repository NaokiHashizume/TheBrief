...
export const alt = "The Brief — 資源エネルギー Article";
...
export default async function OgImage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "linear-gradient(135deg, #7c2d12 0%, #9a3412 100%)", fontFamily: "Georgia, serif", padding: 60 }}>
        <div style={{ display: "flex", alignItems: "center" }}>
          <div style={{ fontSize: 14, fontWeight: 700, letterSpacing: 3, color: "#f97316" }}>ENERGY</div>
