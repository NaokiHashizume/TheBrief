...
export const alt = "The Brief — 金融機関 Article";
...
export default async function OgImage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "linear-gradient(135deg, #78350f 0%, #92400e 100%)", fontFamily: "Georgia, serif", padding: 60 }}>
        <div style={{ display: "flex", alignItems: "center" }}>
          <div style={{ fontSize: 14, fontWeight: 700, letterSpacing: 3, color: "#f59e0b" }}>FINANCE</div>
