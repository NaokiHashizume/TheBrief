...
export const metadata: Metadata = {
  title: "金融機関 CF（キャッシュフロー計算書） — Industry",
  description: "金融機関のキャッシュフロー計算書（CF）の業界構造を解説。営業CF・投資CF・財務CFの特徴と主要企業。",
  alternates: { canonical: "https://thebrief.info/industry/finance/cf" },
  openGraph: {
    title: "金融機関 CF（キャッシュフロー計算書） — Industry",
    description: "金融機関のキャッシュフロー計算書（CF）の業界構造を解説。営業CF・投資CF・財務CFの特徴と主要企業。",
    url: "https://thebrief.info/industry/finance/cf",
    siteName: "The Brief",
    locale: "ja_JP",
    type: "website",
  },
...
export default function Page() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <BreadcrumbJsonLd items={[{ name: "Home", href: "/" }, { name: "Industry", href: "/industry" }, { name: "金融機関", href: "/industry/finance" }, { name: "CF", href: "/industry/finance/cf" }]} />
      ...
      <div className="mb-8">
        <h1 className="font-serif text-2xl md:text-3xl font-bold"><T ja="金融機関 — キャッシュフロー計算書（CF）" en="Financial Institutions — Cash Flow Statement" /></h1>
