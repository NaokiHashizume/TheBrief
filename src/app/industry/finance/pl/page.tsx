...
export const metadata: Metadata = {
  title: "金融機関 PL（損益計算書） — Industry",
  description: "金融機関の損益計算書（PL）の業界構造を解説。売上原価率・販管費率・営業利益率の特徴と主要企業のシェア。",
  alternates: { canonical: "https://thebrief.info/industry/finance/pl" },
  openGraph: {
    title: "金融機関 PL（損益計算書） — Industry",
    description: "金融機関の損益計算書（PL）の業界構造を解説。売上原価率・販管費率・営業利益率の特徴と主要企業のシェア。",
    url: "https://thebrief.info/industry/finance/pl",
    siteName: "The Brief",
    locale: "ja_JP",
    type: "website",
  },
...
export default function Page() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <BreadcrumbJsonLd items={[{ name: "Home", href: "/" }, { name: "Industry", href: "/industry" }, { name: "金融機関", href: "/industry/finance" }, { name: "PL", href: "/industry/finance/pl" }]} />
      ...
      <div className="mb-8">
        <h1 className="font-serif text-2xl md:text-3xl font-bold"><T ja="金融機関 — 損益計算書（PL）" en="Financial Institutions — Profit & Loss" /></h1>
