...
export const metadata: Metadata = {
  title: "医薬品・医療介護 CF（キャッシュフロー計算書） — Industry",
  description: "医薬品・医療介護のキャッシュフロー計算書（CF）の業界構造を解説。営業CF・投資CF・財務CFの特徴と主要企業。",
  alternates: { canonical: "https://thebrief.info/industry/pharma/cf" },
  openGraph: {
    title: "医薬品・医療介護 CF（キャッシュフロー計算書） — Industry",
    description: "医薬品・医療介護のキャッシュフロー計算書（CF）の業界構造を解説。営業CF・投資CF・財務CFの特徴と主要企業。",
    url: "https://thebrief.info/industry/pharma/cf",
    siteName: "The Brief",
    locale: "ja_JP",
    type: "website",
  },
...
export default function Page() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <BreadcrumbJsonLd items={[{ name: "Home", href: "/" }, { name: "Industry", href: "/industry" }, { name: "医薬品・医療介護", href: "/industry/pharma" }, { name: "CF", href: "/industry/pharma/cf" }]} />
      ...
      <div className="mb-8">
        <h1 className="font-serif text-2xl md:text-3xl font-bold"><T ja="医薬品・医療介護 — キャッシュフロー計算書（CF）" en="Pharma & Healthcare — Cash Flow Statement" /></h1>
