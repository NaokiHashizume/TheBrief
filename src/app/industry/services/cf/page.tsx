...
export const metadata: Metadata = {
  title: "サービス CF（キャッシュフロー計算書） — Industry",
  description: "サービスのキャッシュフロー計算書（CF）の業界構造を解説。営業CF・投資CF・財務CFの特徴と主要企業。",
  alternates: { canonical: "https://thebrief.info/industry/services/cf" },
  robots: { index: false, follow: false },
  openGraph: {
    title: "サービス CF（キャッシュフロー計算書） — Industry",
    description: "サービスのキャッシュフロー計算書（CF）の業界構造を解説。営業CF・投資CF・財務CFの特徴と主要企業。",
    url: "https://thebrief.info/industry/services/cf",
    siteName: "The Brief",
    locale: "ja_JP",
    type: "website",
  },
...
export default function Page() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <BreadcrumbJsonLd items={[{ name: "Home", href: "/" }, { name: "Industry", href: "/industry" }, { name: "サービス", href: "/industry/services" }, { name: "CF", href: "/industry/services/cf" }]} />
      ...
      <div className="mb-8">
        <h1 className="font-serif text-2xl md:text-3xl font-bold"><T ja="サービス — キャッシュフロー計算書（CF）" en="Services — Cash Flow Statement" /></h1>
