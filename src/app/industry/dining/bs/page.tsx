...
export const metadata: Metadata = {
  title: "外食 BS（貸借対照表） — Industry",
  description: "外食の貸借対照表（BS）の業界構造を解説。資産構成・負債構造・自己資本比率の特徴と主要企業。",
  alternates: { canonical: "https://thebrief.info/industry/dining/bs" },
  robots: { index: false, follow: false },
  openGraph: {
    title: "外食 BS（貸借対照表） — Industry",
    description: "外食の貸借対照表（BS）の業界構造を解説。資産構成・負債構造・自己資本比率の特徴と主要企業。",
    url: "https://thebrief.info/industry/dining/bs",
    siteName: "The Brief",
    locale: "ja_JP",
    type: "website",
  },
...
export default function Page() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <BreadcrumbJsonLd items={[{ name: "Home", href: "/" }, { name: "Industry", href: "/industry" }, { name: "外食", href: "/industry/dining" }, { name: "BS", href: "/industry/dining/bs" }]} />
      ...
      <div className="mb-8">
        <h1 className="font-serif text-2xl md:text-3xl font-bold"><T ja="外食 — 貸借対照表（BS）" en="Food Service — Balance Sheet" /></h1>
