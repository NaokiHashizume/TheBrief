...
import {
  CopyrightOverviewDiagram,
  CopyrightComparisonDiagram,
  CopyrightTimelineDiagram,
  CopyrightFlowDiagram,
  CopyrightRiskMatrixDiagram,
  CopyrightEuActDiagram,
  CopyrightChecklistDiagram,
} from "@/components/AiCopyrightDiagrams";

const SLUG = "ai-copyright-2026";
...
const diagramMap: Record<string, React.FC> = {
  "copyright-overview": CopyrightOverviewDiagram,
  "copyright-comparison": CopyrightComparisonDiagram,
  "copyright-timeline": CopyrightTimelineDiagram,
  "copyright-flow": CopyrightFlowDiagram,
  "copyright-risk-matrix": CopyrightRiskMatrixDiagram,
  "copyright-eu-act": CopyrightEuActDiagram,
  "copyright-checklist": CopyrightChecklistDiagram,
};
