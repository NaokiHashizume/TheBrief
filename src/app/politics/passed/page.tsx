        ...
        {[...passedItems].sort((a, b) => b.effectiveDate.localeCompare(a.effectiveDate)).map((item) => {
          ...
          return (
            <Link
              ...
              className="group block p-5 rounded-xl border border-brief-border hover:border-amber-500/50 transition-all duration-200 hover:bg-brief-card"
            >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap mb-2">
                    ...
                    <span className="text-[10px] tracking-wider uppercase text-foreground/45">
                      <T ja={item.category} en={item.categoryEn ?? item.category} />
                    </span>
                  </div>
                  ...
                  <div className="mt-2 flex items-start gap-1.5">
                    ...
                    <p className="text-xs text-foreground/45 leading-relaxed"><T ja={item.impact} en={item.impactEn ?? item.impact} /></p>
                  </div>
                </div>
