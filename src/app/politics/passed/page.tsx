        ...
        {passedItems.map((item) => {
          ...
          return (
            <Link
              ...
              className="group block p-5 rounded-xl border border-brief-border dark:border-white/5 hover:border-amber-500/50 dark:hover:border-amber-500/50 transition-all duration-200 hover:bg-foreground/[0.01]"
            >
