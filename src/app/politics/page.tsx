  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <Link
        ...
        className="group mt-4 flex items-center justify-between w-full p-5 rounded-xl border-2 border-dashed border-[#8b5cf6]/30 hover:border-[#8b5cf6] hover:bg-[#8b5cf6]/[0.03] transition-all duration-200"
      >
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-full bg-[#8b5cf6]/10 flex items-center justify-center flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#8b5cf6]">
          ...
          <div>
            <h2 className="font-serif text-xl font-bold"><T ja="政治記事" en="Politics Articles" /></h2>
            <span className="text-[9px] tracking-[2px] uppercase text-foreground/50">Politics Articles</span>
            <p className="text-sm text-foreground/55 mt-0.5">
              <T ja="政策課題・制度・政治動向を掘り下げた解説記事" en="In-depth analysis articles on policy, institutions, and political trends" />
            </p>
          </div>
        </div>
