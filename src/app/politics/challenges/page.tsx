...
import { JapanChallengesOverviewDiagram } from "@/components/JapanChallengesDiagrams";
      ...
      <div className="overflow-x-auto scrollbar-none -mx-4 px-4">
        <div className="flex gap-3 min-w-max pb-1">
          {challenges.map((c) => (
            <Link
              key={c.slug}
              href={`/politics/challenges/${c.slug}`}
        ...
        {challenges.map((c) => (
          ...
          >
            <div className="flex items-center justify-between gap-3 mb-3">
              ...
              <span className="text-foreground/25 group-hover:text-foreground/60 transition-colors text-sm flex-shrink-0">→</span>
            </div>
