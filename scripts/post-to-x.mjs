...
以下の手順を必ず守って、TheBrief の記事を元にした「Tips 共有ツイート」を作成してください。
...
【ステップ 1: 正確性確認 (必須)】
web_search で記事タイトルの主要キーワードを検索し、記事の主張・数字・固有名詞が現在も正確かを確認してください。
事実と矛盾する内容をツイートに含めないでください。

【ステップ 2: X 内の需要チェック (必須)】
web_search で「site:x.com [記事のメインキーワード]」または関連キーワード (例: 「ウクライナ 2026」「日銀 利上げ」など) を検索し、
このトピックが現在 X 上で話題になっているか・どんな切り口で議論されているかを確認してください。
需要がある切り口があれば Tips に活かしてください。

【ステップ 3: Tips ツイートの生成】
ニュース告知ではなく、読者がツイートを読むだけで「ためになる知識・視点」を得られる Tips スタイルで書いてください。

Tips スタイルの特徴:
- 冒頭に「💡 知っておきたい Tips」「📌 今日の気づき」「✅ 〇〇について知っておくべきこと」など Tips らしいフレームを使う
- 記事の核心にある insight・ポイント・数字・背景を 1〜2 文で端的に伝える
- 「詳しくはこちら」「続きはこちら↓」などで URL へ誘導する
- 読者が「シェアしたい」「保存したい」と思うような実用的・知的な内容にする

【このアカウントの読者傾向 (重要)】
- 地政学・国際情勢系のキーワードに強く反応する。特に ウクライナ情勢 / イラン / 中東 / 米中対立 / ロシア / 北朝鮮 / 半導体安保 / 台湾有事 など。
- 記事内容に上記関連の論点が少しでもあれば、必ずそれを Tips の insight に盛り込む。
- 直接関係がなくても、グローバル経済・エネルギー・安全保障の文脈で繋げられるなら積極的に絡める。
- ただし無関係な記事に無理やりこじつけて事実を歪めるのは禁止。
...
- ハッシュタグは 3〜4 個。記事と読者の関心に合致する具体的で検索されやすいキーワードを厳選する。
  良い例: #ウクライナ情勢 #イラン #中東情勢 #米中対立 #半導体 #台湾有事 #日銀 #円安 #エネルギー安保 #地政学 #安全保障 など
  避ける: #ニュース #日本 #経済 のような一般的すぎるもの、#TheBrief のようなブランド名 (= 付けない)
- 絵文字は 1〜3 個まで
