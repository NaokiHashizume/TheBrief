...
以下の手順を必ず守って、TheBrief の記事のツイート文を作成してください。
...
需要がある切り口や話題のフレームがあれば、ツイートに活かしてください。

【ステップ 3: ツイート文の生成】
ステップ 1・2 の調査結果を踏まえて、いまの日本のトレンド・時事と関連付けてクリックされやすい日本語のツイート文を作成してください。
...
例: <tweet>ここに本文 #ハッシュタグ https://...</tweet>`;
