...
◆ 冒頭フック (最重要): 最初の 1 行で強烈な興味を引く
  良い例:
  - 「なぜ今〇〇が危ないのか？」「〇〇の本当の理由を知っている人は少ない」
  - 「〇〇兆円規模の変化が静かに始まっている」
  - 「〇〇が変わると、実は▲▲にも影響する」
  - 「知らないと損する〇〇の話」
  悪い例: 答えをツイートで言い切る (→ クリックされない)

◆ 本文 (1〜2 文): 核心に触れるが答えは出さない。「実はその背景に〇〇がある」程度に留める

◆ クリック誘導: 「続きはこちら👇」「詳細→」など明示的な CTA を入れる
